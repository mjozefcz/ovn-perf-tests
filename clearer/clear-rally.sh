#!/bin/bash
neutron floatingip-list  | awk {'print $2'}|xargs -I% -P16 neutron floatingip-disassociate %  
neutron floatingip-list  | awk {'print $2'}|xargs -I% -P16 neutron floatingip-delete %                     
